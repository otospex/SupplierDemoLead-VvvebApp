-- Create a new combined "Method & Certifications" page at /page/method.
-- post_id 17 (current MAX is 16). type=page, template=content/page.html,
-- linked to site_id 1, language_id 1 (en_US). Content reuses the homepage's
-- rich styled components (sd-step method + sd-cert-card badges + stats).
...
VALUES (17, 1, 'publish', '', 'open', '', 0, 0, 'page', 'content/page.html', 0, 0, NOW(), NOW());

INSERT INTO post_to_site (post_id, site_id) VALUES (17, 1);
