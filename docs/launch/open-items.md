...
- [ ] **Audit SEO, reste côté contenu** — voir `docs/launch/seo-audit-2026-09-02.md` §4 : publier le corpus réglementaire en brouillon (Cloud Act, NIS2, RGPD, SecNumCloud, HDS…), trancher le blog, étoffer les intros de termes, page financement, titres trop longs ou sans marque.
